        ...
        <div class="main-container">
            ...
            <div class="content-container">
                <form class="content-form" action="">
                    ...
                    <div class="buttons"><button id="button1" onclick="call_confirm1()"><a id="button1" href="./adminReadNT.jsp">취소</a></button><button class="button2" onclick="call_confirm2()"><a id="button2" href="./adminReadNT.jsp">수정</a></button></div>
                </form>
            </div>
        </div>
    </main>
