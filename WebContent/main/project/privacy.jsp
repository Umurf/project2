...
<body>
        ...
        <main class="main-outline"><!--main시작-->
            ...
            <div class="main-outline-container02">
               <div style="width: 640px; height: auto; margin-bottom: 50px;">
                  <p>
                    <span>
<strong>제1조(목적)</strong><br>
오운완(이하 ‘회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘회사 서비스’)를 이용하는 개인(이하 ‘이용자’ 또는 ‘개인’)의 정보(이하 ‘개인정보’)를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 ‘본 방침’)을 수립합니다.
<br><br>
...
<br><br>
<strong>제6조(개인정보 수집 방법)</strong><br>
...
<br><br>
<strong>제7조(개인정보의 이용)</strong><br>
회사는 개인정보를 다음 각 호의 경우에 이용합니다.<br>
공지사항의 전달 등 회사의 운영에 필요한 경우<br>
회사의 서비스를 제공하기 위한 경우
<br><br>
<strong>제8조(개인정보의 보유 및 이용기간)</strong><br>
회사는 이용자의 개인정보에 대해 개인정보의 수집·이용 목적이 달성을 위한 기간 동안 개인정보를 보유 및 이용합니다.<br>
전항에도 불구하고 회사는 내부 방침에 의해 서비스 부정이용기록은 부정 가입 및 이용 방지를 위하여 회원 탈퇴 시점으로부터 최대 1년간 보관합니다.
<br><br>

<strong>제9조(법령에 따른 개인정보의 보유 및 이용기간)</strong><br>
...
<strong>제10조(개인정보의 파기원칙)</strong><br>

회사는 원칙적으로 이용자의 개인정보 처리 목적의 달성, 보유·이용기간의 경과 등 개인정보가 필요하지 않을 경우에는 해당 정보를 지체 없이 파기합니다.
<br>
<br>
<strong>제11조(서비스 미이용자에 대한 개인정보처리)</strong>
<br>
회사는 1년 동안 회사의 서비스를 이용하지 않은 이용자의 개인정보는 원칙적으로 이용자에게 사전통지하고 개인정보를 파기하거나 별도로 분리하여 저장합니다.<br>
회사는 장기 미이용 이용자의 개인정보는 별도로 분리되어 안전하게 보관하게 되며, 해당 이용자의 통지는 분리 보관 처리 일을 기준으로 최소 30일 이전에 전자우편주소로 전송됩니다.<br>
장기 미이용 이용자는 회사가 미이용자 DB를 별도로 분리하기 전에 계속 서비스를 이용하고자 하는 경우 웹사이트(이하 '모바일앱' 포함)에 로그인하시면 됩니다.<br>
...
<strong>제12조(개인정보파기절차)</strong><br>
...
<strong>제13조(개인정보파기방법)</strong><br>
...
<strong>제14조(광고성 정보의 전송 조치)</strong><br>
...
<strong>제15조(개인정보 조회 및 수집동의 철회)</strong><br>

이용자 및 법정 대리인은 언제든지 등록되어 있는 자신의 개인정보를 조회하거나 수정할 수 있으며 개인정보수집 동의 철회를 요청할 수 있습니다.<br>
이용자 및 법정 대리인은 자신의 가입정보 수집 등에 대한 동의를 철회하기 위해서는 개인정보보호책임자 또는 담당자에게 서면, 전화 또는 전자우편주소로 연락하시면 회사는 지체 없이 조치하겠습니다.
<br><br>



<strong>제16조(개인정보 정보변경 등)</strong><br>
...
<strong>제18조(개인정보 유출 등에 대한 조치)</strong><br><br>
...
<strong>제19조(개인정보 유출 등에 대한 조치의 예외)</strong><br>
...
<strong>제20조(이용자의 쿠키 설치 선택권)</strong><br>
...
<br>
회사는 이용자의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이 관련 부서 및 개인정보 보호 책임자를 지정하고 있습니다.<br>
개인정보 보호 책임자<br>
성명: 노의진<br>
전화번호: 010-9292-1100<br>
이메일: teamounwan@gmail.com
<br><br>

부칙<br>

제1조 본 방침은 2023.08.16부터 시행됩니다.<br>               
                    </span>
                </p>
               </div>
            </div>
